...
class ResNet(nn.Module):
    ...
    def __init__(self, block, blocks_num, num_classes=3, include_top=True, norm_layer=None):
        super().__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
...
def resnet50_fpn_backbone(pretrain_path="/root/.cache/torch/hub/checkpoints/resnet50-0676ba61.pth",
...
if __name__ == '__main__':
    ...
    net = resnet50_fpn_backbone(pretrain_path="",
