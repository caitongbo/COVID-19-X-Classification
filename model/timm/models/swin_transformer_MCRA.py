...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 norm_layer=nn.LayerNorm, ape=False, patch_norm=True,cls_num_heads=1,cls_num_cls=3, lam=0.1,
        ...
        self.classifier = MHA(input_dim=1024, num_heads=cls_num_heads, num_classes=cls_num_cls, lam=lam)
  ...
  # We add our MHA (CSRA) beside the orginal VIT structure below
        self.head = nn.Sequential() # delete original classifier
        self.classifier = MHA(input_dim=1024, num_heads=1, num_classes=3, lam=0.1)
